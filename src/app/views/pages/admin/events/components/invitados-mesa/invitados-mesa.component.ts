...
@Component({
  selector: 'app-evento-invitados-mesa',
  templateUrl: './invitados-mesa.component.html',
  styleUrls: ['./invitados-mesa.component.scss'],
})
export class InvitadosMesaComponent implements OnInit {
  ...
  ngOnInit(): void {
    var s = this.sharedService.listaInvitadosMesas.subscribe(
      (listaInvitados) => {
    ...
    s = this.sharedService.filtroInvitadosMesas.subscribe((filtro: any) => {
